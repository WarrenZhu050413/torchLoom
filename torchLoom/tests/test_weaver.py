...
class TestWeaverEssentials:
    ...
    def test_init(self, weaver):
        ...
        assert weaver._connection_manager._torchLoom_addr == torchLoomConstants.DEFAULT_ADDR
    ...
    async def test_runtime_errors(self, weaver):
        ...
        with pytest.raises(RuntimeError, match="Weaver not initialized"):
            await weaver.subscribe_js("test_stream", "test.subject", "test_consumer", mock_handler)
