...
Config.torchLoom_CONSTANTS_LOG_FILE = os.path.join(
    log_dir, "test_torchLoom_constants.log"
)
Config.torchLoom_UTILS_LOG_FILE = os.path.join(log_dir, "test_torchLoom_utils.log")
Config.torchLoom_CONTROLLER_LOG_FILE = os.path.join(
    log_dir, "test_torchLoom_weaver.log"
)
Config.torchLoom_MONITOR_CLI_LOG_FILE = os.path.join(
    log_dir, "test_torchLoom_monitor_cli.log"
)
