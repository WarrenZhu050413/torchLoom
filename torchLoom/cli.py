...
class MyShell(cmd.Cmd):
    ...
    def __init__(self, nats_url: str = None, completekey="tab", stdin=None, stdout=None):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--command", type=str, help="Single command to execute (non-interactive mode)")
